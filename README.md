...
pthis website is to contain a home paqqge for the user to return to as well as allowing the user to navigaqte to different components using the navigation bar. 
This portfolio will include information for the user to get to know about the author, myself. The website will be compatible with mobile devices and tablets with an user friendly user interface. 
